...
alias 'gitpudn'='git pull upstream main --no-edit' #could stand for "git pull upstream main"
alias 'gitpudnpp'='git pull upstream main --no-edit && git pull origin main && git push origin main' #for personal use - not intended for widespread
